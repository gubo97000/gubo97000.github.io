...
<div>
	<a href="https://gubo97000.github.io/aniCheck/" target="_blank"
		><h1>AniCheck<Icon icon="pepicons-print:open" inline={true} /></h1></a
	>
	<h3>Completion rate of all the anime manga series on AniList</h3>
